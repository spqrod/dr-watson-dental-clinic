        ...
        <div>
            <section id="services-hero-section">
                <div id="services-hero-text">
                    <h1>Everything you expect from a dentist.<br/>
                        And some more.<br/></h1>
                    <p class="headline">See the list of our services below</p>
                        <div class="button">
                            <a href="https://drwatsondental.com/appointment">Book Appointment</a>
                        </div>
            ...
            <section id="services-section"> 
                ...
                <div>
                    ...
                    <div class="service-description-and-animation">
                        <p class="service-description">It’s the foundation of any dental planning. 
                        ...
                        <div class="service-animation" id="animation-container-1"></div>
                    </div>
                </div>
                <div>
                    <h3>Preventive Dental Care</h3>
                    <div class="service-description-and-animation">
                        <p class="service-description">An ounce of prevention is worth a pound of cure.
                        ...
                        <div class="service-animation" id="animation-container-2"></div>
                    </div>
                </div>
                <div>
                    <h3>Scaling And Polishing</h3>
                    <div class="service-description-and-animation">
                        <p class="service-description">Over time more acidic environment in your mouth may lead to stains and damage to the enamel.
                        ...
                        <div class="service-animation" id="animation-container-3"></div>
                    </div>
                </div>
                <div>
                    <h3>Fillings And Restorations</h3>
                    <div class="service-description-and-animation">
                        <p class="service-description">Tooth decay may damage your tooth. 
                        ...
                        <div class="service-animation" id="animation-container-4"></div>
                    </div>
                </div>
                <div>
                    <h3>Dental Extractions</h3>
                    <div class="service-description-and-animation">
                        <p class="service-description">When the tooth is decayed or damaged beyond repair, 
                        ...
                        <div class="service-animation" id="animation-container-5"></div>
                    </div>
                </div>
                <div>
                    <h3>Wisdom Tooth Removal</h3>
                    <div class="service-description-and-animation">
                        <p class="service-description">Sometimes the wisdom tooth is growing incorrectly and should be removed. 
                        ...
                        <div class="service-animation" id="animation-container-6"></div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="service-description-and-animation">
                        ...
                        <div class="service-animation" id="animation-container-7"></div>
                    </div>
                </div>
            </section>
        </div>
