...
function Footer() {
    ...
    return (
        <footer>
            ...
            <nav id="footerMenu">
                <ul>
                    <li><a className="footerMenu-link" href="https://drwatsondental.com/">Home</a></li>
                    <li><a className="footerMenu-link" href="https://drwatsondental.com/appointment">Appointment</a></li>
                    <li><a className="footerMenu-link" href="https://drwatsondental.com/services">Services</a></li>
                    <li><a className="footerMenu-link" href="https://drwatsondental.com/contact">Contact</a></li>
                    <li><a className="footerMenu-link" href="https://drwatsondental.com/about">About</a></li>
                    <li><a className="footerMenu-link" href="https://drwatsondental.com/blog">Blog</a></li>
                    <li><a className="footerMenu-link" href="https://drwatsondental.com/privacy">Privacy Policy</a></li>
                    <li><a className="footerMenu-link" href="https://drwatsondental.com/terms">Terms and Conditions</a></li>
                </ul>
            </nav>
        <p>
